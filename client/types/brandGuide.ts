...
export interface BrandGuide {
  ...
  // Summary
  purpose?: string; // Why the brand exists
  mission?: string; // What the brand does
  vision?: string; // Where the brand is going
  ...
  // Visual Identity
  logoUrl?: string;
  fontFamily?: string; // Primary brand font (Google Fonts or custom)
  fontSource?: "google" | "custom"; // Where the font comes from
  customFontUrl?: string; // URL or base64 for custom fonts
  primaryColors: string[]; // hex codes
  // Backwards-compatible single-value and legacy fields
  primaryColor?: string;
  ...
  setupMethod?: "ai_generated" | "detailed"; // How the brand was created
