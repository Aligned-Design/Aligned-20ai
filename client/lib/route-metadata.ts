...
export const ROUTE_METADATA: Record<string, RouteMetadata> = {
  ...
  "/": {
    ...
    description:
      "Transform your content workflow with AI. Aligned AI handles planning, writing, scheduling, and reporting so you can focus on what matters.",
    noindex: false,
  ...
  "/about": {
    ...
    description:
      "Learn about our mission to make content creation feel less like a grind and more like a superpower.",
    noindex: false,
  },
  "/features": {
    path: "/features",
    ...
    description:
      "Explore AI content generation, smart scheduling, real-time analytics, collaboration tools, and more.",
    noindex: false,
  ...
  "/integrations": {
    ...
    description:
      "Integrate with Facebook, Instagram, LinkedIn, Twitter, TikTok, Google Business Profile, and more.",
    noindex: false,
  },
  "/help": {
    path: "/help",
  ...
  "/terms": {
    ...
    description:
      "Read our complete terms of service, usage agreement, and legal policies for using Aligned AI.",
    noindex: false,
  ...
  "/pricing": {
    ...
    description:
      "Start at $199/mo per brand. Scale smarter with agency pricing. No hidden fees.",
    noindex: false,
 ...
 */
export function getRoutesByVisibility(
  visibility: RouteVisibility,
): RouteMetadata[] {
