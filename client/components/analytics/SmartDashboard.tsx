...
export function SmartDashboard({ userRole, hasGoals = false, className }: SmartDashboardProps) {
  ...
  const allMetrics: MetricCard[] = [
    ...
    },
    {
      ...
      helpText: 'Percentage of people who interacted with your content (likes, comments, shares)',
      priority: 'high',
    },
    {
      id: 'followers',
  ...
  return (
    <div className={className}>
          ...
          <CardContent className="pt-6">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-indigo-900 mb-1">New to Analytics?</h3>
                <p className="text-sm text-indigo-800 mb-3">
                  Start by focusing on these 3 key metrics. They'll tell you how many people see your content,
                  how engaged they are, and if your audience is growing.
                </p>
      ...
      <div className={cn(
        'grid gap-6',
        displayMetrics.length === 3 ? 'grid-cols-1 md:grid-cols-3' :
        displayMetrics.length === 5 ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5' :
      ...
      {userRole === 'client' && (
        <Card className="mt-6 border-green-200 bg-green-50">
          <CardContent className="pt-6">
            <h3 className="font-bold text-green-900 mb-2 text-lg">What This Means</h3>
            <p className="text-green-800 text-sm leading-relaxed">
              People loved your content this month! Your posts reached <strong>382K people</strong>,
              and <strong>5.4%</strong> of them engaged (that's great!). You gained{' '}
              <strong>1,847 new followers</strong> who are excited to see more from you.
            </p>
          </CardContent>
        </Card>
      )}
