...
export function SmartRefreshSettings({ onRefresh, className }: SmartRefreshSettingsProps) {
          ...
          <RadioGroup value={refreshMode} onValueChange={handleModeChange}>
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <Label htmlFor="daily" className="font-bold text-slate-900 cursor-pointer">
                      Daily Digest
                    </Label>
                  ...
                  <p className="text-sm text-slate-600">
                    Updates once per day at 9:00 AM. Reduces anxiety and encourages strategic thinking.
                  </p>
              ...
              >
                ...
                <div className="flex-1">
                  <Label htmlFor="hourly" className="font-bold text-slate-900 cursor-pointer block mb-1">
                    Hourly Refresh
                  </Label>
                  <p className="text-sm text-slate-600">
              ...
              >
                ...
                <div className="flex-1">
                  <Label htmlFor="manual" className="font-bold text-slate-900 cursor-pointer block mb-1">
                    Manual Only
                  </Label>
                  <p className="text-sm text-slate-600">
                    You control when to see new data. Maximum control, zero distraction.
                  </p>
                </div>
                {refreshMode === 'manual' && (
                  <CheckCircle className="h-5 w-5 text-indigo-600 flex-shrink-0" />
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  Constant updates can create anxiety and encourage reactive behavior.
                  Batched updates help you think strategically and make better decisions.
                </p>
              </div>
            </div>
          </CardContent>
