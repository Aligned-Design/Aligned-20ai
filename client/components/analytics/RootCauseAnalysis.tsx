...
export function RootCauseAnalysis({ changes, onDismiss, className }: RootCauseAnalysisProps) {
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className={cn(
                          ...
                          change.isPositive ? 'text-green-900' : 'text-amber-900'
                        )}>
                          {change.isPositive ? 'Keep the momentum!' : 'Recommended Action:'}
                        </h4>
                        <p className={cn(
                          'text-sm',
                          change.isPositive ? 'text-green-800' : 'text-amber-800'
                        )}>
