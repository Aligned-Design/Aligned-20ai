...
export default function Section1BrandBasics({ data, onChange, errors }: Section1Props) {
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Label htmlFor="shortDescription">
              Short Brand Description <span className="text-destructive">*</span>
            </Label>
          ...
          />
          {errors.shortDescription && <InlineError message={errors.shortDescription} />}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select value={data.industry || ''} onValueChange={(value) => onChange('industry', value)}>
            <SelectTrigger className="min-h-[44px]" aria-invalid={!!errors.industry}>
