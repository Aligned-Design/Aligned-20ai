...
const buttonVariants = (
  ...
  const variantStyles: Record<string, string> = {
    default: "bg-[var(--accent-lime)] text-[var(--indigo-deep)] hover:brightness-105",
    destructive: "bg-red-600 text-white hover:brightness-95",
    outline: "border border-black/10 text-[var(--text-main)] hover:bg-black/5",
    secondary: "bg-transparent border border-black/10 text-[var(--text-main)] hover:bg-black/5",
