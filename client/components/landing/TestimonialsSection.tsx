...
const TESTIMONIALS = [
  {
    ...
    initials: "LFC",
    quote: "We were dropping balls and burning out. Now everything runs smooth, and we actually have energy left for ideas.",
    color: "slate",
  },
  {
    id: 2,
    company: "Indigo & Co",
    initials: "I&Co",
    quote: "Our clients think we built this just for them. We're not correcting them.",
    color: "indigo",
  },
  {
    id: 3,
...
function LogoPlaceholder({ initials, color }: LogoPlaceholderProps) {
  const bgColor =
    color === "indigo" ? "bg-indigo-100 text-indigo-700" : "bg-slate-200 text-slate-700";
  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-white via-slate-50/20 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-1/4 w-80 h-80 bg-indigo-100/15 rounded-full blur-3xl animate-gradient-shift" style={{ animationDelay: "1s" }}></div>
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-blue-100/10 rounded-full blur-3xl animate-float-soft" style={{ animationDelay: "2s" }}></div>
        {/* Light reflection */}
