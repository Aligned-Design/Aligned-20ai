import { Calendar, BarChart3, CheckCircle, Zap, Clock, TrendingUp } from "lucide-react";
...
export function DashboardVisual() {
  return (
    <div className="relative w-full h-full min-h-[400px] flex items-center justify-center">
      ...
      <div className="absolute -top-20 -right-20 w-64 h-64 bg-indigo-200/20 rounded-full blur-3xl animate-float-soft" style={{ animationDelay: "1s" }}></div>
      ...
      <div className="relative w-full max-w-md bg-white/85 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-indigo-300/40 border border-white/70 overflow-hidden hover:shadow-3xl hover:border-white/80 transition-all duration-300 group">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">Content Dashboard</p>
              <p className="text-lg font-black text-slate-900">Today's Aligned</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-indigo-50/50 backdrop-blur-sm rounded-lg p-3 border border-indigo-300/50 hover:border-indigo-400/70 hover:bg-indigo-50/80 transition-all">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-bold text-indigo-700">Scheduled</span>
              </div>
            ...
            <div className="bg-purple-50/50 backdrop-blur-sm rounded-lg p-3 border border-purple-300/50 hover:border-purple-400/70 hover:bg-purple-50/80 transition-all">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-bold text-purple-700">Next Post</span>
              </div>
          ...
          <div className="bg-lime-50/50 backdrop-blur-sm rounded-lg p-3 border border-lime-300/50 hover:border-lime-400/70 hover:bg-lime-50/80 transition-all group">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-slate-600 group-hover:text-slate-800 transition-colors mb-1">💡 Smart Insight</p>
                <p className="text-xs text-slate-700 group-hover:text-slate-900 transition-colors">Best time to post: 2-4 PM EST</p>
              </div>
          ...
          <div className="pt-2 border-t border-slate-200/50 text-center">
            <p className="text-xs font-medium text-slate-500">Managed across 5 brands • All in one place</p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:block absolute -bottom-4 -right-8 w-40 h-32 bg-white/40 backdrop-blur-lg rounded-xl shadow-lg border border-white/60 p-4 transform rotate-3">
        <p className="text-xs font-bold text-slate-700 mb-2">Content Pipeline</p>
      ...
      <div className="hidden md:block absolute -top-6 -left-12 w-36 h-28 bg-white/40 backdrop-blur-lg rounded-xl shadow-lg border border-white/60 p-4 transform -rotate-2">
        ...
        <div className="flex gap-2">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-xs font-bold text-white">A</div>
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-xs font-bold text-white">B</div>
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center text-xs font-bold text-white">C</div>
        </div>
      </div>
    </div>
  );
