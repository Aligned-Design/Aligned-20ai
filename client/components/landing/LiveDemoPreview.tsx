  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-white via-slate-50/20 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-indigo-100/15 rounded-full blur-3xl animate-float-soft" style={{ animationDelay: "2s" }}></div>
        {/* Light reflection */}
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            This is your dashboard. Everything visible, everything organized, everything working for you.
          </p>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-indigo-300/30 border border-white/70 overflow-hidden hover:shadow-3xl hover:border-white/80 transition-all duration-300 group">
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 md:px-8 py-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm font-black text-white">Your Aligned Week</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold text-indigo-700 group-hover:text-indigo-900 transition-colors">Scheduled</span>
                  </div>
                  <p className="text-3xl font-black text-indigo-900 group-hover:text-indigo-950 transition-colors">
                    {displayedStats.posts}
                  </p>
                  <p className="text-xs text-indigo-600 group-hover:text-indigo-700 transition-colors mt-1">posts queued</p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-emerald-600 group-hover:text-emerald-700 transition-colors mt-1">week over week</p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-purple-600 group-hover:text-purple-700 transition-colors mt-1">awaiting review</p>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div
                      ...
                      style={{
                        transitionDelay: isAnimating ? `${500 + idx * 100}ms` : "0ms",
                      }}
                    >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-700">
                    "Your best posting time is 2-4 PM EST. I've scheduled 3 posts
                    for Monday during that window."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 border-t border-slate-200/50 px-6 md:px-8 py-4">
              <p className="text-xs font-medium text-slate-500 text-center">
                ✨ All your brands, integrated. All your approvals, streamlined. All your time, reclaimed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <button className="px-8 py-3 bg-lime-400 hover:bg-lime-300 text-indigo-950 font-black rounded-xl transition-all shadow-lg shadow-lime-400/30 hover:shadow-xl inline-flex items-center gap-2">
            Try Demo Free
