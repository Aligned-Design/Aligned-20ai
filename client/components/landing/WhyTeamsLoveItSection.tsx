  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-white via-indigo-50/10 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-1/3 w-80 h-80 bg-blue-100/15 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "1s" }}></div>
        {/* Light reflection */}
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-slate-700 mb-6 leading-relaxed">
            You don't do cookie-cutter. You care about color palettes, client calls, and captions that actually sound human. You've built a reputation on details — and Aligned was built to protect them.
          </p>
          <p className="text-base sm:text-lg text-slate-700 leading-relaxed">
            Because other AI tools create content. Aligned creates consistency. Always on. Always aligned.
          </p>
        </div>
        ...
        <div className="space-y-8 hidden">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-700 leading-relaxed group-hover:text-slate-900 transition-colors">
              Multi-workspace account management. White-labeled client portals. Built-in approvals. Designed for teams managing 10, 50, or 100+ brands. Not a single-user tool trying to be everything.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-700 leading-relaxed group-hover:text-slate-900 transition-colors">
              Unlike generic AI content tools, Aligned learns your brand tone, style, and strategy. Every post, email, and caption sounds like *you*—not like a robot.
            </p>
          </div>

          <div className={`bg-white/45 backdrop-blur-xl rounded-2xl border border-indigo-200/60 p-8 md:p-10 hover:bg-white/70 hover:border-indigo-400/70 hover:shadow-xl hover:shadow-indigo-200/40 transition-all group cursor-pointer ${
            titleVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}>
            <h3 className="text-2xl font-black text-slate-900 mb-4 group-hover:text-indigo-900 transition-colors">
            ...
            <p className="text-base sm:text-lg text-slate-700 leading-relaxed group-hover:text-slate-900 transition-colors">
              Brand guides, content creation, scheduling, approvals, analytics—all in one place. No context switching. No syncing between tools. No confusion.
            </p>
          </div>
        </div>
      </div>
