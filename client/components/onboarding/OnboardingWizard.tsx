  ...
  const loadOnboardingSteps = async () => {
    ...
    const agencySteps: OnboardingStep[] = [
      ...
      },
      {
        ...
        helpContent: {
          tooltips: [
            { selector: '#agency-name', content: 'This name will appear on all client-facing materials', position: 'bottom' },
            { selector: '#brand-colors', content: 'Choose colors that match your agency\'s brand identity', position: 'right' }
          ]
        }
      },
      {
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-gray-600">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{currentStepIndex} of {steps.length} completed</span>
            </div>
          </div>
        </div>
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              ...
              <span className="text-sm text-gray-500">{currentStep.estimatedTime} minutes</span>
            </div>
          </CardHeader>
...
function getStepIcon(stepId: string) {
  ...
  return icons[stepId as keyof typeof icons] || <Rocket className="h-8 w-8 text-blue-600" />;
}
  ...
  return (
    <div className="text-center space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
        {userType === 'agency' ? (
          <>
            <FeatureCard icon="🤖" title="AI Content Creation" description="Generate posts in your brand voice" />
            <FeatureCard icon="👥" title="Team Collaboration" description="Streamlined approval workflows" />
            <FeatureCard icon="📊" title="Powerful Analytics" description="Prove ROI to your clients" />
          </>
        ) : (
          <>
            <FeatureCard icon="📈" title="Performance Insights" description="See how your content performs" />
            <FeatureCard icon="✅" title="Easy Approvals" description="Review and approve posts quickly" />
            <FeatureCard icon="💬" title="Direct Communication" description="Collaborate with your agency" />
          </>
        )}
      </div>
    </div>
...
function AgencySetupStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Set up your agency profile to get started with client management.</p>
...
function BrandSetupStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Add your first client brand to start creating content.</p>
...
function IntegrationsStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Connect social media accounts to publish and analyze content.</p>
...
function FirstPostStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Let's create your first AI-generated social media post.</p>
...
function TeamInviteStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Invite team members to collaborate on content creation.</p>
...
function DashboardTourStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Take a quick tour of your dashboard features.</p>
...
function ApprovalProcessStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Learn how to review and approve content from your agency.</p>
...
function AnalyticsBasicsStepContent() {
  return (
    <div className="space-y-6">
      <p className="text-center text-gray-600">Understand your social media analytics and key metrics.</p>
