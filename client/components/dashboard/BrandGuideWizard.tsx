        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="mb-8 max-w-md mx-auto">
            <input
              ...
              className="w-full px-6 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-lg font-bold placeholder-slate-400"
              onKeyDown={(e) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-2">AI-Powered Setup</h3>
                <p className="text-slate-600 mb-6">
                  Get AI-generated suggestions for your brand summary, tone, and guidelines. Perfect for getting started quickly.
                </p>
