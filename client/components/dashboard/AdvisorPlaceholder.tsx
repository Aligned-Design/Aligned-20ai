    ...
    ? [
        {
          icon: "🎤",
          title: "Tone Profile",
          message: `Your tone is ${brand.friendlinessLevel}% friendly and ${brand.confidenceLevel}% confident. This creates a warm yet authoritative voice perfect for building trust.`,
          color: "indigo",
        },
        {
          icon: "✨",
          ...
          message:
            brand.tone.length > 3
              ? `Your keywords (${brand.tone.slice(0, 3).join(", ")}...) align well with your mission. Consider emphasizing these in your messaging.`
          ...
          message: `Your guide is ${brand.completionPercentage}% complete. ${
            brand.completionPercentage < 100
              ? `Add ${[
                  ...
                  !brand.guardrails?.length && "guardrails",
                ]
                  .filter(Boolean)
