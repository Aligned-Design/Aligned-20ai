      ...
      <div className="bg-gradient-to-br from-indigo-50 via-white to-blue-50 rounded-xl border border-indigo-100 p-8">
        ...
        <div className="grid grid-cols-3 gap-3 pt-4 border-t border-indigo-100">
          <div className="text-center py-2">
            ...
            <p className="text-lg font-black text-indigo-600">{brand.tone.length}</p>
          </div>
          <div className="text-center py-2">
            <p className="text-xs text-slate-600 font-bold mb-1">COLORS</p>
            <p className="text-lg font-black text-indigo-600">{brand.primaryColors.length + brand.secondaryColors.length}</p>
          </div>
          <div className="text-center py-2">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-black text-indigo-600">{brand.friendlinessLevel}%</span>
            </div>
            <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-blue-400 to-emerald-400 transition-all duration-300"
                style={{ width: `${brand.friendlinessLevel}%` }}
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-black text-indigo-600">{brand.formalityLevel}%</span>
            </div>
            <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-amber-400 to-purple-400 transition-all duration-300"
                style={{ width: `${brand.formalityLevel}%` }}
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-black text-indigo-600">{brand.confidenceLevel}%</span>
            </div>
            <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-pink-400 to-rose-500 transition-all duration-300"
                style={{ width: `${brand.confidenceLevel}%` }}
              />
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                ...
                {editingField === "voiceDescription" ? (
                  ...
                  <p className="text-sm text-slate-700">{brand.voiceDescription}</p>
                )}
              </div>
              {editingField !== "voiceDescription" && (
                <button
                  onClick={() => startEditing("voiceDescription", brand.voiceDescription || "")}
          ...
          <div>
            ...
            <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
              ...
              <p className="text-xs text-slate-600">
                {brand.fontSource === "google" ? "Google Font: " : "Custom Font: "}
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                ...
                {editingField === "visualNotes" ? (
                  ...
                  <p className="text-sm text-slate-700">{brand.visualNotes}</p>
                )}
              </div>
              {editingField !== "visualNotes" && (
                <button
                  onClick={() => startEditing("visualNotes", brand.visualNotes || "")}
