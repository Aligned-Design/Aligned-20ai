          ...
          <div className="sticky top-0 bg-slate-50 border-b border-slate-200 p-6 space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-lime-400"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full font-semibold text-sm transition-all ${
                      selectedProviders.includes(provider)
                        ...
                        : "bg-slate-200 text-slate-600 opacity-50"
                    }`}
                  >
              ...
              <select
                ...
                className="px-3 py-1.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-lime-400"
              >
