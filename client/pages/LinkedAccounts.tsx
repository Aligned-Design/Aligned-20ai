    ...
    <MainLayout>
      <div className="min-h-screen bg-gradient-to-b from-indigo-50/30 via-white to-blue-50/20">
        <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {linkedAccounts
                ...
                .map((account) => (
                  <div
                    key={account.id}
                    className="p-4 bg-white/50 backdrop-blur-xl border border-white/60 rounded-lg hover:border-lime-400/50 transition-all duration-200 hover:shadow-lg hover:shadow-lime-400/10"
                  >
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-white/40">
                      ...
                      <button className="p-1.5 text-indigo-600/60 hover:text-red-500 hover:bg-red-50 rounded transition-colors">
          ...
          {linkedAccounts.some((acc) => acc.status === "disconnected") && (
            <div className="mb-12">
              <h2 className="text-lg font-black text-indigo-950 mb-4">
                Disconnected
              </h2>
          ...
          {/* Error Accounts */}
          {linkedAccounts.some((acc) => acc.status === "error") && (
            <div className="mb-12">
                  ...
                  .map((account) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2 pt-3 border-t border-red-200/30">
                        <button className="flex-1 px-3 py-2 text-xs font-semibold bg-red-100 hover:bg-red-200 text-red-950 rounded transition-colors">
                          Reconnect
                        </button>
                        <button className="flex-1 px-3 py-2 text-xs font-semibold bg-white/50 hover:bg-white/70 text-indigo-600 rounded transition-colors">
                          Disconnect
                        </button>
                      </div>
                    </div>
