      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-6 py-12 text-center">
          ...
          <p className="text-lg text-slate-600 mt-3">
            Questions? Schedule a demo or reach out and we'll get back within
            one business day.
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-slate-600 mb-6">
                Our team can help you get started with onboarding, integrations,
                or custom pricing.
              </p>
            ...
            <div>
              ...
              <p className="text-slate-600 mb-6">
                Pick a time to see the platform in action and discuss your
                needs.
              </p>
