      ...
      const mockIntegrations: Integration[] = [
        {
          ...
          name: 'Instagram',
          logo: '📷',
          description: 'Connect your Instagram Business account to schedule posts and access analytics',
          category: 'social',
          status: 'connected',
          isConnected: true,
        ...
        },
        {
          ...
          logo: '📊',
          description: 'Track website traffic and conversions from social media',
          category: 'analytics',
          status: 'error',
          isConnected: false
        },
