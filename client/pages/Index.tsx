...
export default function Index() {
  return (
    ...
    >
          ...
          <Reveal className="mx-auto">
            <div className="rounded-2xl bg-white/6 backdrop-blur-md border border-white/8 p-12 shadow-2xl">
              ...
              <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-2xl mx-auto leading-relaxed">
                Three specialized AI agents working together to create, review,
                and publish on-brand content across all your social platforms.
              </p>
      ...
      {/* Features Section */}
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 relative z-10 bg-gray-50">
        <Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16 items-stretch">
            ...
            <Card className="rounded-2xl bg-white border border-gray-100 p-6 shadow-md transform transition-transform hover:-translate-y-2 h-full">
              ...
              <CardContent>
                <p className="text-slate-600">
                  Creates templates, graphics, and visual content that matches
            ...
            <Card className="rounded-2xl bg-white border border-gray-100 p-6 shadow-md transform transition-transform hover:-translate-y-2 h-full">
              ...
              <CardContent>
                <p className="text-slate-600">
                  Analyzes performance data and recommends optimal posting times
      ...
      {/* Workflow Section */}
      <div className="bg-white py-12 md:py-20 relative z-10">
      ...
      <div className="bg-gray-50 py-12 md:py-20 border-t border-b border-gray-100 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <Reveal>
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-slate-600">
                  Aligned AI was built by agency professionals who understand
                  the real challenges: managing multiple client brands, keeping
                  approvals streamlined, and proving ROI to stakeholders.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 items-stretch">
                <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
                  ...
                  <p className="text-sm text-slate-600">
                    Manage unlimited brands with separate workflows,
                    permissions, and white-label dashboards—all from one agency
                    account.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
                  ...
                  <p className="text-sm text-slate-600">
                    Let clients approve content without seeing your full
                    platform. Branded portals, clear feedback, zero confusion.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
                  ...
                  <p className="text-sm text-slate-600">
                    Dashboard metrics, performance reports, and growth insights
                    you can show clients to justify retainers.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 p-6 bg-white rounded-2xl border border-gray-100">
                <p className="text-slate-700 text-center">
                  ...
                  Aligned AI was built to enhance your team's expertise, not
                  replace it. You stay in the driver's seat while AI handles the
                  repetitive work.
                </p>
              </div>
            </Reveal>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg,#14223a 0%, #3a1466 100%)",
        }}
      >
        <Reveal>
...
function WorkflowStep({
  ...
  return (
    <div className="text-center">
      <div
        className={`w-12 h-12 ${colorClasses[color]} rounded-full flex items-center justify-center mx-auto mb-4 border border-gray-100 shadow-sm`}
      >
