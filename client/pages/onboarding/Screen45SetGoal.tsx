    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50/30 via-white to-blue-50/20 p-4">
      <div className="max-w-2xl mx-auto pt-6">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 mb-2">Set Your First Goal</h1>
          <p className="text-slate-600 font-medium">
            (Optional) What would you like to achieve in the next 30 days?
          </p>
        </div>
          ...
          <div className="bg-white/50 backdrop-blur-xl rounded-2xl border border-white/60 p-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 text-xs text-slate-600 mt-4">
                <span>💡</span>
                <p>
                  This goal helps the Advisor suggest content strategies. You can adjust it anytime in Brand Guide settings.
                </p>
              </div>
            </div>
          </div>
