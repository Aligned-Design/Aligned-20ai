      ...
      return (
        <div className="group/card rounded-lg overflow-hidden bg-white/50 hover:bg-white/70 border border-indigo-200/20 hover:border-indigo-300/50 transition-all duration-300 hover:shadow-md flex flex-col h-full">
          ...
          <div className="p-4 flex flex-col flex-1">
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 font-medium pt-2 border-t border-indigo-200/30">
              ...
              <PostActionMenu
                ...
                onDuplicate={() => console.log("Duplicate:", post.id)}
                onSchedule={() => console.log("Schedule:", post.id)}
                onChangeStatus={() => console.log("Change Status:", post.id)}
                onAssign={() => console.log("Assign:", post.id)}
                onMoveCampaign={() => console.log("Move Campaign:", post.id)}
          ...
          <div className="px-4 pb-4 flex gap-2 opacity-0 group-hover/card:opacity-100 transition-opacity">
            <button className="flex-1 px-2 py-1.5 rounded text-xs font-bold bg-indigo-100 hover:bg-indigo-200 text-indigo-600 transition-colors flex items-center justify-center gap-1">
              <Edit3 className="w-3 h-3" />
              Edit
            </button>
            <button className="flex-1 px-2 py-1.5 rounded text-xs font-bold bg-lime-100 hover:bg-lime-200 text-lime-600 transition-colors flex items-center justify-center gap-1">
