...
describe('Webhook Handler', () => {
  ...
  describe('Signature Verification', () => {
    it('should verify valid HMAC-SHA256 signature', () => {
      ...
      const isValid = handler.verifySignature('zapier', body, signature, secret);
    ...
    it('should reject invalid signature', () => {
      ...
      const isValid = handler.verifySignature('zapier', body, invalidSignature, secret);
    ...
    it('should handle unknown provider gracefully', () => {
      ...
      const isValid = handler.verifySignature('unknown' as any, body, signature, 'secret');
      expect(isValid).toBe(false);
    });
  });
  ...
  describe('Backoff Calculation', () => {
    ...
    it('should respect max delay cap', () => {
      const largeAttempt = calculateBackoffDelay(20, DEFAULT_WEBHOOK_RETRY_CONFIG);
      expect(largeAttempt).toBeLessThanOrEqual(DEFAULT_WEBHOOK_RETRY_CONFIG.maxDelayMs);
    });
