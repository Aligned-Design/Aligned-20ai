...
export class WordPressClient {
  ...
  async updatePost(postId: number, updates: Partial<WordPressPost>): Promise<WordPressPost> {
  ...
  async scheduleBlogPost(postId: number, publishDate: string): Promise<WordPressPost> {
    return this.request(`/posts/${postId}`, 'POST', {
      status: 'future',
      date: publishDate,
    });
